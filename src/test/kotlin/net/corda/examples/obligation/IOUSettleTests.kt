...
//        val iou = Obligation(10.POUNDS, ALICE, BOB)
...
//                output { outputCash }
//                command(BOB.owningKey) { Cash.Commands.Move() }
//                command(ALICE.owningKey, BOB.owningKey) { ObligationContract.Commands.Settle() } // Correct Type.
//                this.verifies()
//            }
//        }
//    }
...
//        val iouOne = Obligation(10.POUNDS, ALICE, BOB)
//        val iouTwo = Obligation(5.POUNDS, ALICE, BOB)
//        val inputCash = createCashState(5.POUNDS, BOB)
//        val outputCash = inputCash.withNewOwner(newOwner = ALICE).second
//        ledger {
//            transaction {
//                input { iouOne }
//                input { iouTwo }
//                command(ALICE.owningKey, BOB.owningKey) { ObligationContract.Commands.Settle() }
...
//        val iou = Obligation(10.DOLLARS, ALICE, BOB)
...
//                command(BOB.owningKey) { cashPayment.first }
//                output { iou.pay(5.DOLLARS) }
//                command(ALICE.owningKey, CHARLIE.owningKey) { ObligationContract.Commands.Settle() }
...
//                command(BOB.owningKey) { cashPayment.first }
//                output { iou.pay(5.DOLLARS) }
//                command(BOB.owningKey) { ObligationContract.Commands.Settle() }
//                failsWith("Both lender and borrower together only must sign IOU settle transaction.")
//            }
//            transaction {
//                input { cash }
