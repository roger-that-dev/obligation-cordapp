...
//            val iouStates = serviceHub.vaultService.linearHeadsOfType<net.corda.iou.state.IOUState>()
//            val iouToSettle = iouStates[linearId] ?: throw IllegalArgumentException("Obligation with linearId $linearId not found.")
...
//            val settleCommand = Command(net.corda.iou.contract.IOUContract.Commands.Settle(), listOf(counterparty.owningKey, me.owningKey))
...
//                val settledIOU: net.corda.iou.state.IOUState = iouToSettle.state.data.pay(amount)
